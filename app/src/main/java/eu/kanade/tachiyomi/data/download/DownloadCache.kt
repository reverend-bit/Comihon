...
class DownloadCache(
    ...
    fun isChapterDownloaded(
        ...
        if (sourceDir != null) {
            val mangaDirName = provider.getMangaDirName(mangaTitle)
        ...
        rootDownloadsDirMutex.withLock {
            ...
            if (sourceDir == null) {
                if (manga.source == LocalSource.ID) {
                    val localSourceDir = storageManager.getLocalSourceDirectory() ?: return
                    sourceDir = SourceDirectory(localSourceDir)
                } else {
        ...
        renewalJob = scope.launchIO {
            ...
            rootDownloadsDirMutex.withLock {
                ...
                if (localSourceDir != null) {
                    sourceDirs[LocalSource.ID] = SourceDirectory(localSourceDir)
                }

                updatedRootDir.sourceDirs = sourceDirs
